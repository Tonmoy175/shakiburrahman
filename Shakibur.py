...
\033[1;96m ┈┈┈┈▕╲▂▂╱▏┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈▕╲▂▂╱▏┈┈┈┈
\033[1;96m ╱▔▔▔▔┊┊┊┊▔▔▔▔╲☞☞☞☞☞☞\033[1;91m☜☜☜☜☜╱▔▔▔▔┊┊┊┊▔▔▔▔╲
\033[1;96m................\033[1;93mShakibur Rahman\033[1;91m...............
\033[1;96m................\033[1;93m✬🄵🄰🄲🄴🄱🄾🄾🄺✬\033[1;91m..............

\033[1;96m░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░

\033[1;91m☞ Auther     : SHAKIBUR RAHMAN
\033[1;92m☞ WhatsApp   : 01908-735166
\033[1;95m☞ YouTube    : https://youtube.com/channel/UCWIXz-s_vmGjLs2miV2y7jg
...
def login():
	...
	try:
		...
		if 'access_token' in z:
		    ...
		    os.system('xdg-open https://youtube.com/channel/UCWIXz-s_vmGjLs2miV2y7jg')
		    menu()
		else:
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update Shakibur King Tool')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/SHAKIBUR')
	    os.system('cd $HOME && git clone https://github.com/tonmoy175/SHAKIBUR')
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
	    ...
	    psb('WellCome To SHAKIBUR')
	    psb('Congratulations SHAKIBUR Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ 786786✓')
	    psb('🔓Password ☆ 786786✓')
	    psb('Subscrib My Youtube Channel THE UNIQUE LTD✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/Shakibur4 && python2 B4.py')
	elif bm =='3':
